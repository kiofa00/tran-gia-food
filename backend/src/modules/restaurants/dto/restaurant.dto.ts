import {
  IsString, IsOptional, IsNumber, IsUrl, IsObject, Min, Max,
...
export class CreateRestaurantDto {
  ...
  @ApiPropertyOptional({ example: 8.0, description: 'Bán kính phục vụ (km), tối đa 10km (system limit)' })
  @IsOptional()
  @IsNumber()
  @Min(0.5)
  @Max(10)
...
export class UpdateRestaurantDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsObject() openingHours?: Record<string, { open: string; close: string }>;
